...
var unitTestAssemblies = @"./tests/Rabbitr.Net.UnitTests/Rabbitr.Net.UnitTests.csproj";
var minCodeCoverage = 76.4d;
var coverallsRepoToken = "coveralls-repo-token-rabbitr-net";
var coverallsRepo = "https://coveralls.io/github/sharpn/Rabbitr.Net";
...
// stable releases
var tagsUrl = "https://api.github.com/repos/sharpn/rabbitr.net/releases/tags/";
	...
	.Does(() =>
	{
		if (IsRunningOnWindows())
		{
			...
			OpenCover(tool => 
				...
				.WithFilter("+[Rabbitr.Net*]*")
				.WithFilter("-[xunit*]*")
				.WithFilter("-[Rabbitr.Net*Tests]*")
			);
